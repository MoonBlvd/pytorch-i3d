...
#        -root /home/data/vision7/A3D_2.0/frames/ \
#        -val_split A3D_2.0_val.json \
#        -ckpt /home/data/vision7/brianyao/DATA/i3d_outputs/r2plus1d_18/6aw474y3/005000.pt  \
#        -batch_per_gpu 3
...
python run_i3d_for_features.py \
      ...
      -root /home/data/vision7/A3D_2.0/frames/ \
      -val_split A3D_2.0_val.json \
      -ckpt /home/data/vision7/brianyao/DATA/i3d_outputs/mc3_18/f5f860vi/003000.pt  \
      -batch_per_gpu 6
